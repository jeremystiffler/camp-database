...
export const TRIAL_EMAIL_SEQUENCE: TrialEmailDefinition[] = [
  {
    ...
    preview: "Your no-card trial is active. Start by building your first event setup.",
    heading: "Your event command center is ready.",
    intro: "Welcome to Simple Schedule Pro. Your 14-day free trial is active, and no credit card is required. The fastest way to see the value is to build your first event setup.",
    bullets: ["Add your event name and dates", "Create age groups", "Add rooms, teachers, and activities", "Build your schedule", "Open registration when you are ready"],
    ctaLabel: "Set up your event",
    ctaPath: "/setup",
    footer: "You are also eligible for the Founding Event Offer: 50% off your first year if you upgrade during the launch period.",
  },
  {
    step: "setup_day_1",
    day: 1,
    subject: "Your simple event setup checklist",
    preview: "Do these first to get your event ready faster.",
    ...
    bullets: ["Add your event info", "Create age groups", "Add rooms and teachers", "Add activities/classes", "Build your schedule", "Preview registration"],
  ...
  },
  {
    ...
    heading: "Show parents a form that feeds the rest of your event.",
  ...
  },
  {
    ...
    intro: "A registration form is helpful. A registration form connected to a real event schedule is where the magic starts.",
  ...
  },
  {
    ...
    intro: "If you have already started setup, now is a great time to finish the pieces that turn Simple Schedule Pro into your real event workflow.",
    bullets: ["Event setup", "Activities/classes", "Schedule", "Registration form", "Confirmation email", "Check-in and print tools"],
    ctaLabel: "Continue your event setup",
    ctaPath: "/dashboard",
  ...
  },
  {
    ...
    preview: "Keep your event setup active with 50% off your first year.",
    ...
    bullets: ["Launch: $299/year, $149.50 first year", "Event Pro: $799/year, $399.50 first year", "Organization: $1,499/year, $749.50 first year", "Paid registrations include a simple 3% platform fee, usually paid by the registrant"],
    ctaLabel: "View plans",
    ctaPath: "/#pricing",
  ...
  },
  {
    ...
    preview: "Last day to keep your event moving without interruption.",
    ...
    bullets: ["Founding customers get 50% off the first year", "Monthly plans start at $29/month", "Yearly plans start at $299/year", "Your event setup stays connected when you upgrade"],
    ctaLabel: "Keep your event active",
    ctaPath: "/#pricing",
    footer: "Do not let a good event setup wander into the wilderness like an unattended permission slip.",
  },
  {
    step: "expired",
    day: 14,
    ...
    intro: "Your setup work is still worth protecting. Your event info, activities, registration setup, and schedule can keep moving when you choose a plan.",
    bullets: ["Launch: $149.50 first year", "Event Pro: $399.50 first year", "Organization: $749.50 first year", "3% paid-registration platform fee, usually paid by registrants"],
    ctaLabel: "Choose a plan",
    ctaPath: "/#pricing",
    footer: "We are building this for event directors, volunteers, coaches, teachers, real families, and the heroic people trying to avoid one more spreadsheet.",
  },
  {
    step: "rescue_day_17",
    day: 17,
    subject: "Need more time with Simple Schedule Pro?",
    preview: "Come back and finish your event setup.",
    heading: "Still thinking it over?",
    intro: "If you did not get enough time to finish your setup, we understand. Event season has a way of turning every day into a dodgeball tournament for your attention.",
    bullets: ["Review your event setup", "Finish registration", "Test a sample participant registration", "Try check-in and print tools", "Choose the plan that fits your size"],
