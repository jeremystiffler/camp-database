...
export const TRIAL_EMAIL_SEQUENCE: TrialEmailDefinition[] = [
  {
    ...
    preview: "Your no-card trial is active. Start by building your first program setup.",
    heading: "Your program command center is ready.",
    intro: "Welcome to Simple Schedule Pro. Your 14-day free trial is active, and no credit card is required. The fastest way to see the value is to build your first program setup.",
    bullets: ["Add your program name and dates", "Create age groups", "Add rooms, teachers, and activities", "Build your schedule", "Open registration when you are ready"],
    ctaLabel: "Set up your program",
    ctaPath: "/setup",
    footer: "You are also eligible for the Founding Program Offer: 50% off your first year if you upgrade during the launch period.",
  },
  {
    step: "setup_day_1",
    day: 1,
    subject: "Your simple program setup checklist",
    preview: "Do these first to get your program ready faster.",
    ...
    bullets: ["Add your program info", "Create age groups", "Add rooms and teachers", "Add activities/classes", "Build your schedule", "Preview registration"],
  ...
  },
  {
    ...
    heading: "Show parents a form that feeds the rest of your program.",
    intro: "Once your basic setup is in place, the next big win is your registration form. Registration connects directly to participant records, class counts, and your schedule.",
    bullets: ["Participant and guardian info", "Emergency contacts", "Custom questions", "Age group selection", "Class choices", "Payments if needed", "Confirmation emails"],
  ...
  },
  {
    ...
    preview: "Connect activities, teachers, rooms, time blocks, and age groups.",
    heading: "Build a schedule staff and families can actually use.",
    intro: "A registration form is helpful. A registration form connected to a real program schedule is where the magic starts.",
    bullets: ["Time blocks", "Rooms", "Teachers", "Activities", "Age groups", "Required sessions", "Class choices", "Capacity limits"],
    ctaLabel: "Open Schedule Builder",
    ctaPath: "/schedule",
    footer: "If you only have 10 minutes today, add one day of time blocks and a few activities.",
  },
  {
    step: "halfway_day_7",
    day: 7,
    ...
    intro: "If you have already started setup, now is a great time to finish the pieces that turn Simple Schedule Pro into your real program workflow.",
    bullets: ["Program setup", "Activities/classes", "Schedule", "Registration form", "Confirmation email", "Check-in and print tools"],
    ctaLabel: "Continue your program setup",
    ctaPath: "/dashboard",
  ...
  },
  {
    ...
    preview: "Keep your program setup active with 50% off your first year.",
    ...
    bullets: ["Launch: $299/year, $149.50 first year", "Program Pro: $799/year, $399.50 first year", "Organization: $1,499/year, $749.50 first year", "Paid registrations include a simple 3% platform fee, usually paid by the registrant"],
    ctaLabel: "View plans",
    ctaPath: "/#pricing",
  ...
  },
  {
    ...
    preview: "Last day to keep your program moving without interruption.",
    ...
    bullets: ["Founding customers get 50% off the first year", "Monthly plans start at $29/month", "Yearly plans start at $299/year", "Your program setup stays connected when you upgrade"],
    ctaLabel: "Keep your program active",
    ctaPath: "/#pricing",
    footer: "Do not let a good program setup wander into the wilderness like an unattended permission slip.",
  },
  {
    step: "expired",
    day: 14,
    ...
    intro: "Your setup work is still worth protecting. Your program info, activities, registration setup, and schedule can keep moving when you choose a plan.",
    bullets: ["Launch: $149.50 first year", "Program Pro: $399.50 first year", "Organization: $749.50 first year", "3% paid-registration platform fee, usually paid by registrants"],
    ctaLabel: "Choose a plan",
    ctaPath: "/#pricing",
    footer: "We are building this for program directors, volunteers, coaches, teachers, real families, and the heroic people trying to avoid one more spreadsheet.",
  },
  {
    step: "rescue_day_17",
    day: 17,
    subject: "Need more time with Simple Schedule Pro?",
    preview: "Come back and finish your program setup.",
    heading: "Still thinking it over?",
    intro: "If you did not get enough time to finish your setup, we understand. Program season has a way of turning every day into a dodgeball tournament for your attention.",
    bullets: ["Review your program setup", "Finish registration", "Test a sample participant registration", "Try check-in and print tools", "Choose the plan that fits your size"],
...
function renderTrialEmail(definition: TrialEmailDefinition, user: TrialEmailUser) {
  ...
  <div style="max-width:620px;margin:0 auto;padding:32px 16px;">
    ...
    <p style="text-align:center;margin:18px 0 0;font-size:12px;color:#94a3b8;">Simple Schedule Pro — built for program directors, volunteers, and spreadsheet survivors.</p>
  </div>
</body></html>`;
