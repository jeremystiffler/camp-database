...
export default function LoginPage() {
  ...
  const handleGoogleSignIn = () => {
    if (window.google?.accounts?.oauth2) {
      // We need to get the client instance — but initTokenClient doesn't return it in the global flow
      // Instead, let's use the renderButton approach
    }
  };
      ...
      <div className="w-full max-w-md">
        ...
        <button
          ...
          onClick={() => {
            ...
            // Use the GIS popup flow directly
