...
export default function SuperAdminPage() {
  ...
  return <main className="mx-auto max-w-6xl p-6 md:p-10"><div className="mb-8"><p className="text-xs font-extrabold uppercase tracking-widest text-forest-600">Simple Schedule Pro</p><h1 className="mt-1 text-3xl font-extrabold text-slate-950">Super Admin</h1><p className="mt-2 max-w-2xl text-slate-600">Control site-wide tester and subscription promotions. These are separate from camp registration coupons, and only the platform Super Admin can manage them.</p></div>
